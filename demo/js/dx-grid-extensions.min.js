...
dxGridExtension.factory('conditionalFormattingConfiguration', function ($log, customColumnConfiguration) {
    ...
    var rules = [{
        ...
        "items": [{
            ...
            formatting: function formatting(options, value, rule, dataSource) {
                ...
                var fieldHtml = "<div><div class='formatting bar superpose' style='background:" + rule.color + ";width:" + value / total * 100 + "%;''></div> <div class='formatting superpose'  style='z-index: 10;margin-top:-16px;'>" + options.text + "  </div></div>";
