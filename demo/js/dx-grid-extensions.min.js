...
dxGridExtension.controller('customColumns', function customColumnsCrtl($scope, $controller, $timeout, $log, customColumnConfiguration) {
    ...
    function applyCustomColumnExpression() {
        ...
        try {
            ...
            if (_.some($scope.self.gridManagement.columns, function (column) {
                return column.caption === $scope.customColumnName;
            })) throw new Error("Column " + $scope.customColumnName + " already exist");
            if (_.some($scope.self.gridManagement.customColumns, function (column) {
                return column.caption === $scope.customColumnName;
            })) throw new Error("Column " + $scope.customColumnName + " already exist");
...
dxGridExtension.controller('baseGridManagement', function baseGridManagementCrtl($scope, management, datasource, $controller) {
    ...
    function updateAvailableColumns() {
        $scope.availableColumns = _.sortBy(_.transform($scope.management.columns.concat($scope.management.customColumns), function (result, item) {
