dxGridExtensionDemo
    .controller('demo', function demoCrtl($scope) {
        ...
        $scope.demoFlatGridOptions = {
            ...
            bindingOptions: {
                dataSource: 'widget.demoFlatData',
                'summary.groupItems': 'widget.config.flatGrid.groupItems',
                'columns': 'widget.config.flatGrid.columns'
            },
            height: height,
            resize: true,
        ...
        $scope.demoTreeGridOptions = {
            bindingOptions: {
                dataSource: 'widget.demoTreeData',
                columns: 'widget.config.treeGrid.columns',
                expandedRowKeys: 'widget.rootId'
            },
            height: height,
            keyExpr: "uniqueId",
